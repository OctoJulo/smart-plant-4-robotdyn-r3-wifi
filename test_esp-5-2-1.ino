...
//#include <BearSSLHelpers.h>j fais sauter toutes les bibliotheques qui n ont pas rougies sur l editeur
...
#define DHTPIN 2 //remplacement 
#define DHTTYPE    DHT11 //remplacement
DHT dht(DHTPIN, DHTTYPE); //remplacement
...
Adafruit_MQTT_Publish temperture = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/temperture"); // coquille tempreture sans doute
